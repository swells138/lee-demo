export default function About() {
  return (
    <div className="mx-auto max-w-5xl space-y-4 p-4">
      ...
      <p>
        Certified in ServSafe and dedicated to the highest standards, we serve
        events across Ohio with a focus on quality and safety. From our vibrant
        food trailer to full-service catering and training classes, we handle it
        all with care.
      </p>
    </div>
  );
